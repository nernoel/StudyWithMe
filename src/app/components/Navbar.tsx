...
export default function Navbar(){
    ...
    return (
        <div className="mt-8 ml-4 mr-4 fixed top-0 left-0 right-0 flex justify-between items-center h-16 bg-sky-50 rounded-full px-4">
          <div className="flex items-center">
            <span className="text-4xl font-bold text-gray-800">StudyWithMe</span>
          </div>
