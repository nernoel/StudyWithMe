...
export default function CreatePostForm() {
    ...
    return (
        <div>
            <button
                onClick={openModal}
                className="mb-4 rounded-xl font-extrabold text-green-500 bg-green-50 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
            >
                Create a new post
            </button>
